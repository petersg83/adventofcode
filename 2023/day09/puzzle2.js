...
const reversedMetricsHistory = metricsHistory.map(metricHistory => metricHistory.reverse());
const sum = reversedMetricsHistory.reduce((sum, metricHistory) => sum + getNextValue(metricHistory), 0);
console.log(sum);